                            ...
                            <div class="card-body">
                              <div class="card-title" >New Invoice</div>
                                    <div class="form-row">
                                            ...
                                            <div class="col-md-3">
                                                <label >Raw Material From </label>
                                                <select  class="form-control"  style=" width: 100%" name="raw_material_from" id="raw_material_from" >
                                                  <option  <?php if(isset($res2[0]['raw_material_from'])){if($res2[0]['raw_material_from']==''){echo "selected";}}?>  value="">Select</option>
                                                  <option  <?php if(isset($res2[0]['raw_material_from'])){if($res2[0]['raw_material_from']=='Faridabad'){echo "selected";}}?>  value="Faridabad">Faridabad</option>
                                                  <option  <?php if(isset($res2[0]['raw_material_from'])){if($res2[0]['raw_material_from']=='Visakhapatnam'){echo "selected";}}?>  value="Visakhapatnam">Visakhapatnam</option>
                                                </select>
                                            </div>   
                                                  ...
                                                  <div class="widget-box">
                                                    ...
                                                    <div class="widget-content nopadding">
                                                      ...
                                                      <div style=" margin-left:50px;">
                                                        ...
                                                        <input class="form-control-new" readonly value="Dis. %" type="text" style=" height:30px; width:80px; border:none; background-color:#f7f7f5;" />
                                                        <input class="form-control-new" readonly value="Act Rate" type="text" style=" height:30px; width:80px; border:none; background-color:#f7f7f5;" />
                                                        ...
                                                        if(isset($res3) and count($res3)>0)
                                                        {
                                                          ...
                                                          foreach($res3 as $w)
                                                          {
                                                              ...
                                                              <div id="readrootjr101" style="display:;  margin-bottom:20px; margin-top:10px;">
                                                                ...
                                                                <input type="text" style="height:33px;   width:200px;  "   class="goods2"   id="goods2_<?php echo $c;?>"  onKeyUp="fun_get_product(this.id,'goods2_','goods_','get_grade_lotno_list')" value="<?php echo $pname;?>" />
                                                                <input type="hidden"  class="goods"  id="goods_<?php echo $c;?>" value="<?php echo $product_id;?>"  />
                                                                ...
                                                                <input type="text"   style="height:33px;   width:80px;  " id="prePrice_<?php echo $c;?>" name="prePrice[]" class="prePrice"  onKeyUp="fun_invoice_price(this.id)"  value="<?php if(isset($w['prePrice']))echo $w['prePrice'];?>" />
                                                                <input type="text"   style="height:33px;   width:80px;  " id="discount_<?php echo $c;?>" name="discount[]" class="discount"  onKeyUp="fun_invoice_price(this.id)"  value="<?php if(isset($w['discount']))echo $w['discount'];?>" />
                                                                <input type="text"   style="height:33px;   width:80px;  " id="price_<?php echo $c;?>" name="price[]" class="price"  onKeyUp="fun_invoice_price(this.id)"  value="<?php if(isset($w['price']))echo $w['price'];?>" />
                                                        ...
                                                        else
                                                        {
                                                          ?>
                                                            <div id="readrootjr101" style="display:;  margin-bottom:20px; margin-top:10px;">
                                                              ...
                                                              <input type="hidden"  class="goods"  id="goods_"   name="goods[]"  />
                                                              ...
                                                              <input type="text"   style="height:33px;   width:80px;  " id="prePrice_" name="prePrice[]" class="prePrice"  onKeyUp="fun_invoice_price(this.id)" />
                                                              <input type="text"   style="height:33px;   width:80px;  " id="discount_" name="discount[]" class="discount"  onKeyUp="fun_invoice_price(this.id)" />
                                                              <input type="text"   style="height:33px;   width:80px;  " id="price_" name="price[]" class="price"  onKeyUp="fun_invoice_price(this.id)" />
                                            ...
                                            <div class="col-md-12" style="margin-top:30px; margin-bottom:30px;">   
                                                  ...
                                                  <div class="col-md-4" style="height:80px; float:left">
                                                      <label  >External weighbridge Weight in kgs.</label>
                                                      <input type="text" class="form-control" id="ext_weight_bridge" name="ext_weight_bridge"  value="<?php if(isset($res2[0]['ext_weight_bridge']))echo $res2[0]['ext_weight_bridge'];?>">
                                                    </div>


                                                    <div class="col-md-4" style="height:80px;float:left">
                                                      <label  >Internal weighbridge Weight in kgs.</label>
                                                      <input type="text" class="form-control" id="int_weight_bridge" name="int_weight_bridge"  value="<?php if(isset($res2[0]['int_weight_bridge']))echo $res2[0]['int_weight_bridge'];?>">
                                                    </div>

                                                    <div class="col-md-4" style="height:80px;float:left">
                                                      <label  >difference Weight in kgs.</label>
                                                      <input type="text" class="form-control" id="diff_weight_bridge" name="diff_weight_bridge"  value="<?php if(isset($res2[0]['diff_weight_bridge']))echo $res2[0]['diff_weight_bridge'];?>">
                                                    </div>
                                            ...
                                            <div class="col-md-12" style="margin-top:30px; margin-bottom:30px;">   
                                                  <div class="panel-body">
                                                    <div class="col-md-6" style="height:80px;float:left">
                                                      <label  >Coil wise Details </label>
                                                      <textarea class="form-control" id="coil_wise_details" name="coil_wise_details"><?php if(isset($res2[0]['coil_wise_details'])){echo $res2[0]['coil_wise_details'];}?></textarea>
                                                    </div>
