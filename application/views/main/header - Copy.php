...
<body class="text-left">
    <div class="app-admin-wrap layout-horizontal-bar">
         <div class="main-header" style="background-color:<?php if(isset($design[0]['details1'])){echo $design[0]['details1'];}else{echo "red";}?>; color:<?php if(isset($design[0]['details2'])){echo $design[0]['details2'];}else{echo "white";}?>;">
            <div class="logo"  style="width:250px; "><img  src="<?php echo base_url(); if(isset($company[0]['details3'])){echo $company[0]['details3'];}?>" alt="company logo" style="width:100%"></div>
            <div class="menu-toggle">
                <div></div>
                <div></div>
                <div></div>
            ...
            <div class="d-flex align-items-center">
                  <div  class="dropdown mega-menu d-none d-md-block">
                    <h3><?php if(isset($company[0]['details1'])){echo $company[0]['details1'];}?></h3>
                </div>
            </div>
                                    ...
                                    ?>
                                        <!-- <li class="nav-item menu_item"  data-item="<?php echo $m['id_name']?>"><span class="nav-text"><?php echo $m['name']?></span></li> -->
                                         <li>
                                            <div>
                                                <div>
                                                    <label class="toggle" for="drop-2">Name</label><a href="#"><i class="nav-icon mr-2 i-Bar-Chart"></i><?php echo $m['id_name']?></a>
