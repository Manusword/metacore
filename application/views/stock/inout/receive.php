                              ...
                              <div class="card-title  ">Material Details</div>
                                    ...
                                    <input type="hidden"  id="stock_inout_id"  value="<?php if(isset($res2[0]['stock_inout_id']))echo $res2[0]['stock_inout_id'];?>">
                                          ...
                                          <div class="col-md-4" style="margin-top:20px">
                                                ...
                                                <select class="form-control select2"    id="in_from">
                                                      <option  <?php if(isset($res2[0]['in_from'])){if($res2[0]['in_from']==''){echo "selected";}}?>  value="">Select</option>

                                                      <option <?php if(isset($res2[0]['in_from'])){if($res2[0]['in_from']=="WD"){ echo "selected"; }}?> >WD</option>

                                                      <option <?php if(isset($res2[0]['in_from'])){if($res2[0]['in_from']=="Wet"){ echo "selected"; }}?> >Wet</option>

                                                      <option <?php if(isset($res2[0]['in_from'])){if($res2[0]['in_from']=="Mini"){ echo "selected"; }}?> >Mini</option>

                                                      <option <?php if(isset($res2[0]['in_from'])){if($res2[0]['in_from']=="GI"){ echo "selected"; }}?> >GI</option>

                                                      <option <?php if(isset($res2[0]['in_from'])){if($res2[0]['in_from']=="Rope"){ echo "selected"; }}?> >Rope</option>

                                                      <option <?php if(isset($res2[0]['in_from'])){if($res2[0]['in_from']=="Party"){ echo "selected"; }}?> >Party</option>

                                                      <option <?php if(isset($res2[0]['in_from'])){if($res2[0]['in_from']=="Other"){ echo "selected"; }}?> >Other</option>
                                                </select>
                                          </div> 
                                          ...
                                          <div class="col-md-3" style="margin-top:20px">
                                                <label >Dia</label>
                                                <input type="text" class="form-control"  id="dia" required onKeyUp="getAllWdCoils()" autocomplete="off" value="<?php  if(isset($res2[0]['dia']))echo $res2[0]['dia'];?>" >
                                          </div>
                                          ...
                                          <div class="col-md-3" style="margin-top:20px">
                                                <label >Grade</label>
                                                <select class="form-control select2"    id="grade" onchange="getAllWdCoils(),getAllWdCoilsList()">
                                          ...
                                          <div class="col-md-12" style="margin-top:20px" id="dis_output2">
                                                   <?php 
                                                   if(isset($res2[0]['stock_inout_id'])){
                                                      $this->Qcmodel->getAllWdCoilsList_from_id($res2[0]['stock_inout_id']);
                                                   }
                                                   
                                                   if(isset($res2[0]['psize']) && isset($res2[0]['dia']) && isset($res2[0]['grade_id'])){
                                                      $this->Qcmodel->getAllWdCoilsList_from_size_dia_grade($res2[0]['psize'],$res2[0]['dia'],$res2[0]['grade_id']);
                                                   } 
                                                   ?>
                                          </div> 
                                            ...
                                            <div class="col-md-12" style="margin-top:50px;">                            
                                              <div class="box-footer">
                                                    <div class="col-md" align="center" ><span id="wait" style="color:orange; display:none;"><div class="spinner spinner-info mr-3"></div></span>
                                                      <button type="button" class="btn btn-success" id="receive_stock_save" >Save</button>
                                                    </div>
                                                </div>
                                            </div>   
