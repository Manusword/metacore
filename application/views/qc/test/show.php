   ...
   <div class="main-content">
     <div class="breadcrumb">
       ...
       <div class="col-md-2">
         ...
         <input type="text" class="form-control" id="search_date1" name="search_date1" value="<?php if (isset($search_date1)) {
                                                                                                echo $search_date1;
                                                                                              } else {
                                                                                                echo date('d-m-Y');
                                                                                              } ?>" required>
       ...
       <div class="col-md-2">
         <label>To Date</label>
         <input type="text" class="form-control" id="search_date2" name="search_date2" value="<?php if (isset($search_date2)) {
                                                                                                echo $search_date2;
                                                                                              } else {
                                                                                                echo date('d-m-Y');
                                                                                              } ?>" required>
       ...
       <div class="col-md-1">
         <input type="button" id="test1_search" class="btn" style=" margin-top:25px; background-color:<?php echo $this->Company->table_bg_color(); ?>; color:<?php echo $this->Company->table_ft_color(); ?>;" name="search" value="Search">
       </div>
       ...
       <div class="col-md-12">
         <div class="card mb-4">
           <div class="card-body">
             ...
             <div id="table_show">
               <?php $this->load->view('qc/test/show_table', $res2); ?>
             </div>
