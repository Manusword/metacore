    ...
    <table class="table table-bordered table-striped table-sm" id="printed_table" >
        <thead style="background-color:<?php echo $this->Company->table_bg_color();?>; color:<?php echo $this->Company->table_ft_color();?>;">
            <tr>
                ...
                <th>Master HRA</th>
                <th>Master CONV</th>
                <th>Master Advance Deduction</th>
                <th>Master Other Deduction</th>
                <th>Master DOJ</th>
                <th>Master DOR</th>
            ...
            <?php 
                ...
                foreach($res2 as $r)
                {
                    ...
                    <tr>
                        ...
                        <td><?php echo $r['mater_roll'];?></td>
                        <td><?php echo $r['basic_salary_master_roll'];?></td>
                         <td><?php echo $r['hra_master_roll'];?></td>
                        <td><?php echo $r['conv_master_roll'];?></td>
                        <td><?php echo $r['lost_advance_master_roll'];?></td>
                        <td><?php echo $r['other_advance_master_roll'];?></td>
                        <td><?php echo $r['doj_master_roll'];?></td>
                        <td><?php echo $r['dor_master_roll'];?></td>
