    ...
    <table class="table table-bordered table-striped table-sm" id="printed_table" >
        ...
        <tbody>
            <?php 
                ...
                foreach($res2 as $r)
                {
                      if($r['is_leave_eligible'] != 'Yes') continue;
                    ?>
                    <tr>
                          <td>
                            <?php echo $i;?>
                        ...
                        <td><?php echo $r['is_leave_eligible'];?></td>
                        <td><?php echo $r['leave_yearly'];?></td>
                         <td><?php echo $r['leave_cl'];?></td>
                        <td><?php echo $r['leave_sl'];?></td>
                        <td><?php echo $r['leave_el'];?></td>
                        <td><?php echo $r['leave_ol'];?></td>
