            ...
            <?php 
                ...
                foreach($res2 as $r)
                {
                    ...
                    <tr>
                        ...
                        <td>
                             <a  target="_blank"
                            href=" <?php echo base_url()."index.php/Welcome/home?Hr/profile/".$r['emp_code']?>">
                            Profile
                            </a>
                        </td>
                        ...
                        <td>
                             <a  target="_blank"
                                            href=" <?php echo base_url()."index.php/Hr/profile2/".$r['emp_code']?>">
                                            Registration
                                            </a>
                        </td>
                        ...
                        <td>
                              <a  target="_blank"
                                            href=" <?php echo base_url()."index.php/Hr/appointment_latter/".$r['emp_code']?>">
                                            Appointment
                                            </a>
                        </td>
