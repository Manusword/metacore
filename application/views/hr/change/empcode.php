        ...
        <div class="main-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                      <div class="card mb-4">
                            <div class="card-body">
                              <div class="card-title" >Update Employee Code</div>
                                      ...
                                      <form id="other_application_form">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-12" style="margin-top:10px">
                                                  <label style="color:blue">New Employee Code</label>
                                                  <input type="text" class="form-control"  id="new_emp_code" required  autocomplete="off"  >
                                            </div>
                                            ...
                                            <div class="col-md-12" style="margin-top:50px;">                            
                                              <div class="box-footer">
                                                    <div class="col-md" align="center" ><span id="wait" style="color:orange; display:none;"><div class="spinner spinner-info mr-3"></div></span>
                                                      <button type="button" class="btn btn-success" onclick="update_emp_code()" >Update</button>
                                                    </div>
                                                </div>
                                            </div>   
...
function update_emp_code(){
      let  old_emp_code=$('#emp_code').val();
      let  new_emp_code=$('#new_emp_code').val();
     
      let search1='1';
      const url = $('#url').val(); 
      
      if(old_emp_code==''){$('#old_emp_code').focus();fun_message('warning','Warning','Enter Empcode','toast-bottom-right');return false;}
      if(new_emp_code==''){$('#new_emp_code').focus();fun_message('warning','Warning','Enter New Employee Code','toast-bottom-right');return false;}
     
      if(old_emp_code==new_emp_code){fun_message('warning','Warning','Old and New Employee Code are same','toast-bottom-right');return false;}
       
          //-------------------------------getting gst type
          $('.loader').show();
          setTimeout(function() {
            jQuery.post("<?php echo base_url().'index.php/Hr/update_emp_code_save';?>", 
            {
