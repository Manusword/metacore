        ...
        <div class="main-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                      <div class="card mb-4">
                            <div class="card-body">
                              <div class="card-title" style="color:red">Delete Employee Code</div>
                                      ...
                                      <form id="other_application_form">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-12" style="margin-top:30px">
                                                <button type="button" class="btn btn-warning" onclick="delete_emp_code_get_info()" >Get Details</button>
                                            </div>
                                            ...
                                            <div class="col-md-12" id='delete_button' style="margin-top:50px;display:none;">                            
                                              <div class="box-footer">
                                                    <div class="col-md" align="center" ><span id="wait" style="color:orange; display:none;"><div class="spinner spinner-info mr-3"></div></span>
                                                      <button type="button" class="btn btn-danger" onclick="delete_emp_code()" >Delete Employee Paramant</button>
                                                    </div>
                                                </div>
                                            </div>   
...
function delete_emp_code_get_info(){

  let emp_code = $('#emp_code').val();
  if(emp_code==''){
    $('#emp_code').focus();
    fun_message('warning','Warning','Enter Employee Code','toast-bottom-right');
    return false;
  }
  ...
  $.ajax({
    url: "<?php echo base_url().'index.php/Hr/delete_emp_code_info';?>",
    type: "POST",
    dataType: "json",   // 🔥 THIS IS THE KEY
    ...
    success: function(data){
      ...
      $.each(data.counts, function(table, count){
        let badge = count > 0
      ...
      // 👇 profile link under table
      html += `<div style="margin-top:10px;text-align:center">
        <a href="<?php echo base_url().'index.php/Welcome/home?Hr/profile/'; ?>${emp_code}"
           target="_blank"
...
function delete_emp_code(){
      ...
      const url = $('#url').val(); 
          ...
          $('.loader').show();
          setTimeout(function() {
            jQuery.post("<?php echo base_url().'index.php/Hr/delete_emp_code_save';?>", 
            {
              emp_code:emp_code,
              search1:search1,
            }, 
