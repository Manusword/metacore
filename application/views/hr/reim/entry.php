        ...
        <div class="main-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="card mb-4">
                            <div class="card-body">
                              <div class="card-title" >Reimbursement Form</div>
                                            ...
                                            <div class="col-md-12" style="margin-top:50px;">                            
                                              <div class="box-footer">
                                                    <div class="col-md" align="center" ><span id="wait" style="color:orange; display:none;"><div class="spinner spinner-info mr-3"></div></span>
                                                      <button type="button" class="btn btn-success" onclick="add_reim_save()" >Save</button>
                                                    </div>
                                                </div>
                                            </div>   
...
function add_reim_save(){
       ...
       if(subject==''){$('#subject').focus();fun_message('warning','Warning','Enter Deatils','toast-bottom-right');return false;}
       if(amount==''){$('#amount').focus();fun_message('warning','Warning','Enter Reim Amount','toast-bottom-right');return false;}
       if(status==''){$('#status').focus();fun_message('warning','Warning','Enter status','toast-bottom-right');return false;}
          ...
          $('.loader').show();
          setTimeout(function() {
            jQuery.post("<?php echo base_url().'index.php/Hr/add_reim_save';?>", 
            {
              id:id,
              emp_code:emp_code,
