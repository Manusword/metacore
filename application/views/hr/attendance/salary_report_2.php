...
?>
    ...
    <table width="100%" border="1" class="table-striped " style="font-size:15px;"   >
		...
		<tr style="font-weight:bold;">
			<td align='left' colspan='5'>PF Code:- <?php echo $company_pf_code;?></td>
			<td align='left' colspan='5'>ESIC:- <?php echo $company_esi_no; ?></td>
			<td align='center' colspan='15'>[Form XVII ( See Rule 78(a)(i)] Register of Wage </td>
			<td align='center' colspan='12' style="background-color:pink"></td>
		</tr>
		
		<tr style="font-weight:bold;">
			<td align='center' colspan='8'></td>
			<td align='center' colspan='4'>Rate</td>
			<td align='center' colspan='2'>Days & OT</td>
			<td align='center' colspan='5'>Earning</td>
			<td align='center' colspan='4'>Deductions</td>
		...
		foreach($emp as $e)
		{
            ...
            <tr style="height:40px">
				...
				<td  width="100px;"><?php echo $e['pay_code'];?> </td>
            	<td  width="100px;">
					<a target="_blank" href="<?php echo base_url();?>index.php/Hr/salary_slip_print_1<?php echo $link4;?>" ><?php echo $e['first_name'].' '.$e['last_name'];?></a>
				</td>
