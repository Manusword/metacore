        ...
        <div class="main-content">
                <div class="breadcrumb">
                     ...
                     <div class="col-md-1">
                        <input type="button" id="coupon_issue_group_search" class="btn" style=" margin-top:25px; background-color:<?php echo $this->Company->table_bg_color();?>; color:<?php echo $this->Company->table_ft_color();?>;"  name="search" value="Search" >
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-4">
                            <div class="card-body">
                              <div class="card-title" >Canteen Coupon Issue List Name wise</div>
                                <button  onClick="fun_export_xls()" class="btn btn-default">Export to Exls</button>
                                <div id="table_show">
                                    <?php $this->load->view('hr/canteen/show_table_group',$res2);?>
                                </div>  
