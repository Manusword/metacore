        ...
        <div class="main-content">
                <div class="breadcrumb">
                    ...
                    <div class="col-md-1">
                        <input type="button" id="debit_search" class="btn" style=" margin-top:25px; background-color:<?php echo $this->Company->table_bg_color();?>; color:<?php echo $this->Company->table_ft_color();?>;"  name="search" value="Search" >
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="card mb-4">
                            <div class="card-body">
                              <div class="card-title" >Debit List</div>
                               
                                <button  onClick="fun_export_xls()" class="btn btn-default">Export to Exls</button>
                                <div id="table_show"><?php $this->load->view('customer/payment/debit_show_table',$res2);?></div>  
