...
<div class="table-responsive" style="height:500px; overflow:auto;">
    <table class="table table-bordered table-striped table-sm" id="printed_table">
        <thead style="background-color:<?php echo $this->Company->table_bg_color();?>; color:<?php echo $this->Company->table_ft_color();?>;">
            <tr>
                <th colspan="11"></th>
                <td colspan="10" align="center" class="dis_td shift_a" >Shift (A)</td>
                <td colspan="10"  align="center" class="dis_td shift_b">Shift (B)</td>
                <th colspan="7"></th>
            </tr>
            <tr>
                <th>#</th>
                  ...
                  <th class="shift_a">Mtr.Reading</th>
                  ...
                  <th class="shift_b">Mtr.Reading</th>
        ...
        <tbody>
            ...
            foreach($res2 as $r)
            {
                ...
                <tr>
                    ...
                    <td><?php if(isset($r['meter_reading_1']))echo $t15[] = $r['meter_reading_1'];?></td>
                    ...
                    <td><?php if(isset($r['meter_reading_2']))echo $t17[] = $r['meter_reading_2'];?></td>
            ...
            <tr>
              <td>#</td>
                ...
                <td class="shift_a"><?php if(!empty($t15))echo $a15 = array_sum($t15);?> </td>
                ...
                <td class="shift_b"><?php if(!empty($t17))echo $a17 = array_sum($t17);?></td>
