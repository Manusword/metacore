        ...
        <div class="main-content">
                <div class="breadcrumb">
                    ...
                    <div class="col-md-1">
                        <label >Date</label>
                        <input type="number" class="form-control" id="date" value="<?php echo date('d');?>">
                    </div>
                    

                    <div class="col-md-1">
                        <label >Show Details</label>
                        <select class="form-control" id="show_details" >
                    ...
                    <div class="col-md-1">
                        <input type="button" id="production_search5" class="btn" style=" margin-top:25px; background-color:<?php echo $this->Company->table_bg_color();?>; color:<?php echo $this->Company->table_ft_color();?>;"  name="search" value="Search" >
                    </div>
