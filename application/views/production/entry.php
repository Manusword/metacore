                              ...
                              <div class="card-title" >Basic Details</div>
                                    <div class="form-row">
                                            ...
                                            <div class="col-md-2" style="margin-top:10px;">
                                                ...
                                                <input type="text"    class="form-control"   id="goods2_" onKeyUp="fun_get_product(this.id,'goods2_','goods_','diff_id_one_search2')" value="<?php if(isset($in_product_name))echo $in_product_name;?>"  />
                                                <input type="hidden"  class="goods"   id="goods_" value="<?php if(isset($res2[0]['in_product_id']))echo $res2[0]['in_product_id'];?>"  />
                                            </div>
                                            ...
                                            <div  class="col-md-12" id="CurrentRuningDis2"></div>
                                            <div  class="col-md-12"><hr></div>
