        ...
        <div class="main-content">
                <div class="breadcrumb">
                                        ...
                                        <div class="col-md-2" >
                                            <label>Base Size (via click)</label>
                                        ...
                                        <div class="col-md-2" >
                                            <label>Finish Size (via click)</label>
                                       ...
                                       <!--
                                        <div class="col-md-1"> 
                                            <div class="form-group" >
                                                <label for="exampleInputEmail1">OP Name</label>
                     ...
                     <div class="col-md-1">
                        <input type="button" id="production_search" class="btn" style=" margin-top:25px; background-color:<?php echo $this->Company->table_bg_color();?>; color:<?php echo $this->Company->table_ft_color();?>;"  name="search" value="Search" >
                    </div>
                      ...
                      <div class="card mb-4">
                            <div class="card-body">
                              <div class="card-title" >Production List</div>
                                ...
                                <div id="table_show">
                                    <?php $this->load->view('production/show_table',$res2);?>
                                </div>  
